    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if content['submittype'] == 'submit':
                url = '/user/' + str(thisuser.logonid) + '/useradmin'
                message = 'none'
                flash(u'Changes Saved', 'success')
            elif content['submittype'] == 'save':
...
If you made a chamber music request in your camp applicaiton form, it has already been added to the website. Please check your group history page to double-check before making any new requests.\n
